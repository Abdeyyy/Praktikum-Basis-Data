...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2025 at 02:44 PM
...
(p_id_pelanggan, p_id_buku, p_jumlah, v_total_harga, CURDATE());
...
--
DELIMITER $$
CREATE TRIGGER `statusMember` AFTER UPDATE ON `pelanggan` FOR EACH ROW UPDATE pelanggan
